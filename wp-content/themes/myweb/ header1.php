...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'myweb' ); ?></a>
<!-- HEADER
=========================================== -->
...
<div class="navbar-wrapper">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'myweb' ); ?></button>
